...
Definition: "This method lets you determine whether or not a string includes another string."
...
```
The string contains "world" after position 12 hence n returns ```false```. Quite similar to RegEx.test() no?
